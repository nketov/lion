...
for ($tr=1; $tr<=$rows; $tr++){ // в этом цикле счётчик $tr 
    ...
    // $rows.
    echo '<tr>';
        echo '<td><p>'. $tr .'  | Код | Наименование | Производитель | Количество | Цена | <i class="fa fa-eye" aria-hidden="true"></i> |  </p></td>';
    echo '</tr>';
}
...
<p>Сайты с тонкими линиями они как фрики в современном веб-дизайне, но ведь это и прекрасно, они дают нам тот пользовательский опыт который мы ранее не видели. Это нечто свежее и интересное, чего пользователь ранее не видел. Не бойтесь экспериментировать и, возможно, завтра о вашем сайте напишут как о примере искусства.</p>
