...
$cartCounter = '<div class="cart-counter">'.sizeof($_SESSION['cart']).'</div>';
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12">
                    <div class="b-topBar__langMobile">
                        <div class="dropdown">
                            <input id="currency"
                                   value="<?= !empty(Yii::$app->session->get('currency')) ? Yii::$app->session->get('currency') : 'EUR' ?>"
                                   hidden>
                            <a data-toggle="tooltip"
                               title="&nbsp;&nbsp;&nbsp;Евро : <?= $euro ?>&#10;Доллар : <?= $dollar ?>&#10;Рубль : <?= $rur ?>"
                               href="#" class="dropdown-toggle" data-toggle='dropdown'>Валюта</a>

                            <a class="m-langLink dropdown-toggle" data-toggle='dropdown' href="#"><span
                                        id="currency-flag"
                                        class="b-topBar__lang-flag m-en"></span><span
                    ...
                    <nav class="b-topBar__navMobile">
                        <ul>
                            ...
                            <?= Yii::$app->user->isGuest ? (
                                ...
                                . Html::endForm()
                                . '</li>                        <li style="padding-left:-10px; padding-right:-10px;margin-left:-10px; margin-right:-10px"><a href="/cart" title="Корзина"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i></a>'
                                .$cartCounter.'</li><li style="padding-left:-10px; padding-right:-10px;margin-left:-10px; margin-right:-10px"><a href="/cabinet" title="Личный кабинет"><i class="fa fa-street-view" aria-hidden="true"></i></a></li>'
                            ) ?>
